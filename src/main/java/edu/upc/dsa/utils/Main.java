...
import edu.upc.dsa.services.StudentService;
...
public class Main {
    ...
    public static HttpServer startServer() {
        ...
        final ResourceConfig rc = new ResourceConfig().packages("edu.upc.dsa.services");//aqui se mete el package donde se encuentran los archivos de la api rest
